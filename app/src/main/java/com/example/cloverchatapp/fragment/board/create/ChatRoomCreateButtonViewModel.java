...
public class ChatRoomCreateButtonViewModel {
    ...
    public ChatRoomCreateButtonViewModel(MainActivity activity, EditText inputPassword, EditText inputTitle, CheckBox isPrivateChkBox) {
